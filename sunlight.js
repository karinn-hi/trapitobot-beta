...
global.authFile = `trapbotsession`
global.authFileJB = `trapitoBot`
...
console.log('🚩 trapito-Bot no tiene Sub-Bots vinculados.');
return;
}
...
const mainBotAuthFile = 'trapitoSession';
try {
const mainBot = await connectionUpdate(mainBotAuthFile);
global.conns.push(mainBot);
console.log(chalk.bold.greenBright(`🚩 Ai trapito conectado correctamente.`))

await connectSubBots();
} catch (error) {
console.error(chalk.bold.cyanBright(`🍭 Error al iniciar trapito-Bot: `, error))
}
})();
