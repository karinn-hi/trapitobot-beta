<h1 align="center">trapito Bot - 💥</h1>
...
```bash
apt update -y && yes | apt upgrade && pkg install -y bash wget mpv && wget -O - https://raw.githubuser | bash
```
...
```bash
git clone https://github.com && cd Megumin-Bot-MD 
```
...
| APP | TIPO | ENLACE |
|------|-------------|-------|
| WhatsApp | Canal | [¡Click aquí!](https://whatsapp.com/channel/0029VahWu200lwggPxzJsb07) |
| WhatsApp | Canal Sunlight | [¡Click aquí!](https://whatsel/0029Vam7yUg77qVaz3sIAp0z) |
| WhatsApp | Gc Megumin | [¡Click aquí!](https://chat.whatsapp.com/H5bw4MJucS1BBHnZ9wv3vI) |

---

### **`🌴 COLABORADORES`**
<a href="https://github.cos">
<img src="https://contrib.rocks/" /> 
</a>

### **`👑 PROPIETARIO`**
<a
href="https://githu"><img src="https://githu" width="130" height="130" alt="David"/></a>

### **`🌹 CREDITOS`**
<a
href="https://gi"><img src="https://githug" width="130" height="130" alt=""/></a>

[© Powered By Sunlight Team ⚡︎](https://whatsapp)